...
Class InstagramWidget implements NormalWidgetInterface
{
    ...
    protected function build_content( $data )
    {
        ...
        foreach ( $data as $image ) 
        {
            ...
            /**
             * Bug-fix code : #ig_url_1
             */
            $image['link'] = $this->fix_instagram_url($image['link']);
    ...
    protected function fix_instagram_url($image_url){
        if (strpos($image_url, '//www.') !== true) {
            $image_url = str_replace('//', '', $image_url);
            return $image_url = '//www.'.$image_url;
        }
    }
}