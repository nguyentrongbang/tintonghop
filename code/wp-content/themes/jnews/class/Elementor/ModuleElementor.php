...
Class ModuleElementor
{
    ...
    public function elementor_editor_script()
    {
        if ( defined('ELEMENTOR_VERSION') )
        {
            ...
            if ( in_array($version , $available) ) {
	            jnews_deregister_script('elementor-editor');
    ...
    public function editor_script()
    {
        ...
        wp_enqueue_script( 'jnews-elementor-widget-js', get_parent_theme_file_uri( '/assets/js/admin/widget.js' ), null, null, true );
        wp_enqueue_script( 'jnews-elementor-js',        get_parent_theme_file_uri( '/assets/js/admin/elementor-backend.js' ), null, null, true );
