...
<div class="jnews-wrap wrap about-wrap">
    ...
    ?>
        <div class="about-text">
            <?php
                esc_html_e( 'Please activate the license of JNews theme to get official support service and all benefits from JNews. Read below for additional information.', 'jnews' );
            ?>
        </div>
    ...
    <?php else: ?>
        <div class="about-text">
            <?php echo wp_kses(__('Chúc mừng, chủ đề của bạn đã được cài đặt thành công, bạn đã có thể sử dụng - hy vọng bạn sẽ thích nó. Chủ đề của bạn đang được cài từ Website lexuanhao.com', 'jnews'),wp_kses_allowed_html()) ?>
        </div>
